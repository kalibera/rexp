...
{"warning",	dcfun,	0,	111,	4,	{PP_FUNCALL, PREC_FN,	  0}, (DL_FUNC) dc_warning},
...
{"startsWith",	dcfun,  0,	11,	2,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_startsWith, DC_COE},
{"endsWith",	dcfun,  1,	11,	2,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_startsWith, DC_COE},
{"substr",	dcfun,	1,	11,	3,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_substr},
{"substr<-",	dcfun,	1,	11,	4,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_substrgets},
{"strsplit",	dcfun,	1,	11,	5,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_strsplit},
...
#ifdef Win32
{"system",	dcfun,	0,	211,	5,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_system, DC_COE},
#else
{"system",	dcfun,	0,	211,	2,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_system},
#endif
...
{"save",	dcfun,	0,	111,	6,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_save},
{"saveToConn",	dcfun,	0,	111,	6,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_saveToConn},
...
{"serializeToConn",	dcfun,	0,	111,	5,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_serializeToConn},
{"unserializeFromConn",	dcfun,	0,	11,	2,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_unserializeFromConn},
{"deparse",	dcfun,	0,	11,	5,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_deparse},
...
{"print.function",dcfun,0,	111,	2,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_printfunction, DC_COE},
...
{"sys.parent",	dcfun,		1,	11,	1,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.call",	dcfun,		2,	11,	1,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.frame",	dcfun,		3,	11,	1,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.nframe",	dcfun,		4,	11,	0,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.calls",	dcfun,		5,	11,	0,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.frames",	dcfun,		6,	11,	0,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.on.exit",	dcfun,		7,	11,	0,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.parents",	dcfun,		8,	11,	0,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
{"sys.function",dcfun,		9,	11,	1,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sys, DC_COE},
...
{"psort",	dcfun,	0,	11,	2,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_psort},
...
{"formals",	dcfun,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_formals, DC_COE},
{"body",	dcfun,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_body, DC_COE},
...
{"refcnt",      dcfun,      0,       11,     1,     {PP_FUNCALL, PREC_FN, 0}, (DL_FUNC) dc_refcnt},
...
{"setwd",	dcfun,	0,	111,	1,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_setwd},
...
{"Sys.info",	dcfun,	0,	11,	0,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_sysinfo},
...
{"close",	dcfun,	0,      111,     2,      {PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_close},
...
{"gzcon",	dcfun,	0,      11,     4,      {PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_gzcon},
...
{"findInterval",dcfun, 0,	11,	5,	{PP_FUNCALL, PREC_FN,	0}, (DL_FUNC) dc_findinterval},
