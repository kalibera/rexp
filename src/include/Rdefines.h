...
#define GET_CLASS(x)       	getClassAttrib(x)
#define GET_DIM(x)       	getDimAttrib(x)
#define GET_DIMNAMES(x)       	getDimNamesAttrib(x)
#define GET_COLNAMES(x)       	GetColNames(x)
#define GET_ROWNAMES(x)       	GetRowNames(x)
#define GET_LEVELS(x)       	getLevelsAttrib(x)
#define GET_TSP(x)       	getTspAttrib(x)
