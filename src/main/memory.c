...
/* S3 generic testing */
int (IS_SIMPLE_S3GENERIC_CLOSURE)(SEXP x){ return IS_SIMPLE_S3GENERIC_CLOSURE(CHK(x)); }
void (SET_SIMPLE_S3GENERIC_CLOSURE)(SEXP x){ SET_SIMPLE_S3GENERIC_CLOSURE(CHK(x)); }
void (UNSET_SIMPLE_S3GENERIC_CLOSURE)(SEXP x) { UNSET_SIMPLE_S3GENERIC_CLOSURE(CHK(x)); }
