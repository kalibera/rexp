...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_Init = 15,                      /* Init  */
  YYSYMBOL_Items = 16,                     /* Items  */
  YYSYMBOL_nonMath = 17,                   /* nonMath  */
  YYSYMBOL_Item = 18,                      /* Item  */
  YYSYMBOL_environment = 19,               /* environment  */
  YYSYMBOL_20_1 = 20,                      /* $@1  */
  YYSYMBOL_math = 21,                      /* math  */
...
static const char *const yytname[] =
{
  ...
  "ERROR", "MACRO", "TEXT", "COMMENT", "BEGIN", "END", "VERB", "'{'",
  "'}'", "'$'", "$accept", "Init", "Items", "nonMath", "Item",
  "environment", "$@1", "math", "block", YY_NULLPTR
};
