...
SEXP dc_findinterval(SEXP xt, SEXP x, SEXP right, SEXP inside, SEXP leftOp);
...
SEXP dc_gzcon(SEXP argcon, SEXP arglevel, SEXP argallow, SEXP argtext);
...
SEXP dc_body(SEXP call, SEXP op, SEXP env, SEXP fun);
...
SEXP dc_formals(SEXP call, SEXP op, SEXP env, SEXP fun);
...
SEXP dc_startsWith(SEXP call, SEXP op, SEXP env, SEXP x, SEXP Xfix);
