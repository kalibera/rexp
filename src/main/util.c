...
checkArityCallLength(SEXP op, SEXP call, R_len_t nargs)
{
...
{
    checkArityCallLength(op, call, length(args));
}
...
SEXP attribute_hidden dc_nargs(SEXP call, SEXP op, SEXP rho)
{
    RCNTXT *cptr;
...
SEXP attribute_hidden dc_getwd()
{
    return(intern_getwd());
}
    ...
    SEXP paths, SEXP slash, SEXP argmustWork)
{
    ...
    int mustWork = asLogical(argmustWork); /* 1, NA_LOGICAL or 0 */
