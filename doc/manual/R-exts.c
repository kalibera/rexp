...
SEXP out(SEXP x, SEXP y)
{
    ...
    SEXP ans; VAPROTECT(ans, allocMatrix(REALSXP, nx, ny));
    ...
    SEXP dimnames; VAPROTECT(dimnames, allocVector(VECSXP, 2));
...
SEXP numeric_deriv(SEXP args)
{
	...
	VAPROTECT(par, findVar(installChar(STRING_ELT(theta, i)), rho));
	tt = REAL(par)[0];
	xx = fabs(tt);
