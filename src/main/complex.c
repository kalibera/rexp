...
SEXP attribute_hidden dc_complex(SEXP argna, SEXP argre, SEXP argim)
{
    ...
    PROTECT(re = coerceVector(argre, REALSXP));
    PROTECT(im = coerceVector(argim, REALSXP));
    nr = XLENGTH(re);
    ni = XLENGTH(im);
...
SEXP attribute_hidden dc_polyroot(SEXP z)
{
    SEXP zr, zi, r, rr, ri;
    Rboolean fail;
    int degree, i, n;
