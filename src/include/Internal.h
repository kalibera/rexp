...
SEXP do_earg_addCondHands(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_aperm(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_array(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_assign(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_cat(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_copyDFattr(SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP do_crc64(SEXP, SEXP, SEXP, SEXP);
SEXP do_Cstack_info(SEXP, SEXP, SEXP, SEXP);
SEXP do_internal_supports_earg(SEXP, SEXP, SEXP, SEXP);
SEXP do_true_builtin_supports_earg(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_delayed(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_dotcall_simple3(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_dotcall_simple4(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_dotcall_simple5(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_dotcall_simple6(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_drop(SEXP, SEXP, SEXP, SEXP);
SEXP do_dump(SEXP, SEXP, SEXP, SEXP);
SEXP do_duplicated(SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_duplicated(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_anyDuplicated(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_envir(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_first_min(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_formals(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_get(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_is(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_isvector(SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_length(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_ls(SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_makevector(SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_newenv(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_parentenv(SEXP, SEXP, SEXP, SEXP);
SEXP do_parentenvgets(SEXP, SEXP, SEXP, SEXP);
SEXP do_parentframe(SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_parentframe(SEXP, SEXP, SEXP, SEXP);
SEXP do_parse(SEXP, SEXP, SEXP, SEXP);
SEXP do_paste(SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_paste(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP do_earg_paste0(SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_sample(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_shortRowNames(SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_sort(SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_sys(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_putconst(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
SEXP do_earg_stdout(SEXP, SEXP, SEXP);
...
SEXP do_earg_isNSEnv(SEXP call, SEXP op, SEXP args, SEXP rho);
...
SEXP do_earg_getRegNS(SEXP call, SEXP op, SEXP arg_x, SEXP rho);
SEXP do_getNSRegistry(SEXP call, SEXP op, SEXP args, SEXP rho);
SEXP do_earg_getNSRegistry(SEXP call, SEXP op, SEXP rho);
