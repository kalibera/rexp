...
GETBUILTINEARG0.OP = 1,
GETBUILTINEARG1.OP = 1,
GETBUILTINEARG2.OP = 1,
GETBUILTINEARG3.OP = 1,
GETBUILTINEARG4.OP = 1,
GETBUILTINEARG5.OP = 1,
GETBUILTINEARG6.OP = 1,
GETBUILTINEARG7.OP = 1,
GETINTLBUILTINEARG0.OP = 1,
GETINTLBUILTINEARG1.OP = 1,
GETINTLBUILTINEARG2.OP = 1,
GETINTLBUILTINEARG3.OP = 1,
GETINTLBUILTINEARG4.OP = 1,
GETINTLBUILTINEARG5.OP = 1,
GETINTLBUILTINEARG6.OP = 1,
GETINTLBUILTINEARG7.OP = 1,
PUSHEARG.OP = 0,
MAKEPROMEARG.OP = 1,
...
GETBUILTINEARG0.OP <- 117
GETBUILTINEARG1.OP <- 118
GETBUILTINEARG2.OP <- 119
GETBUILTINEARG3.OP <- 120
GETBUILTINEARG4.OP <- 121
GETBUILTINEARG5.OP <- 122
GETBUILTINEARG6.OP <- 123
GETBUILTINEARG7.OP <- 124
GETINTLBUILTINEARG0.OP <- 125
GETINTLBUILTINEARG1.OP <- 126
GETINTLBUILTINEARG2.OP <- 127
GETINTLBUILTINEARG3.OP <- 128
GETINTLBUILTINEARG4.OP <- 129
GETINTLBUILTINEARG5.OP <- 130
GETINTLBUILTINEARG6.OP <- 131
GETINTLBUILTINEARG7.OP <- 132
PUSHEARG.OP <- 133
MAKEPROMEARG.OP <- 134
...
explicitGETBUILTIN <- c(GETBUILTINEARG0.OP, GETBUILTINEARG1.OP, GETBUILTINEARG2.OP, GETBUILTINEARG3.OP, GETBUILTINEARG4.OP, GETBUILTINEARG5.OP, GETBUILTINEARG6.OP, GETBUILTINEARG7.OP)
explicitGETINTLBUILTIN <- c(GETINTLBUILTINEARG0.OP, GETINTLBUILTINEARG1.OP, GETINTLBUILTINEARG2.OP, GETINTLBUILTINEARG3.OP, GETINTLBUILTINEARG4.OP, GETINTLBUILTINEARG5.OP, GETINTLBUILTINEARG6.OP, GETINTLBUILTINEARG7.OP)
...
getGetBuiltinInstruction <- function(explicitArgs) {
  if (explicitArgs == -1) {
    ...
    explicitGETBUILTIN[explicitArgs + 1]
  }
}
...
getGetIntlBuiltinInstruction <- function(explicitArgs) {
  if (explicitArgs == -1) {
    ...
    explicitGETINTLBUILTIN[explicitArgs + 1]
  }
}
...
cmpTrueBuiltin <- function(e, cb, cntxt) {
    explicitArgs = .Internal(true.builtin.supports.earg(e[[1]]))
    if (explicitArgs != -1) {
        if (any.names(e[-1])) {
            cntxt$warn(gettext("Explicit argument passing is not used because the call to", e[[1]], "has names"))
            explicitArgs = -1
        }
    }
    cmpBuiltin(e, cb, cntxt, FALSE, explicitArgs)
}
